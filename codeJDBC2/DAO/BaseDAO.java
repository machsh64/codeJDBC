...
public abstract class BaseDAO<T> {
    ...
    public T getInstance(Class<T> clazz,Connection conn, String sql, Object... args) {
        try {
            //连接数据库
            preStatement = conn.prepareStatement(sql);
    ...
    public List<T> getInstances(Class<T> clazz,Connection conn, String sql, Object ...args) {
        try {
            //连接数据库
            preStatement = conn.prepareStatement(sql);
